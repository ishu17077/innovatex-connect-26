...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="relative flex min-h-screen w-full flex-col justify-center overflow-hidden bg-[#090D2B] bg-grid-pattern text-[#F1FDFD]">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col px-4 sm:px-8 lg:px-12 py-16 sm:py-20 lg:py-24">
        <div className="lg:grid lg:grid-cols-[minmax(0,1.18fr)_minmax(300px,0.82fr)] lg:gap-8 items-center">
            ...
            <div className="max-w-xl w-full">
              <div className="flex flex-col leading-none">
                <div className="flex items-end gap-1 sm:gap-2 uppercase text-[#F1FDFD] font-bbh tracking-[-0.06em] drop-shadow-[0_12px_30px_rgba(0,0,0,0.35)] flex-wrap sm:flex-nowrap">
                  <span className="text-[clamp(2.8rem,7.8vw,6.2rem)] mt-0 lg:mt-6 mr-2 sm:mr-5 leading-none hover:scale-105 transition-transform duration-300">INNOVATE</span>
                  <span className="text-[clamp(4.2rem,11vw,15.2rem)] -mb-1 sm:-mb-3 leading-none text-[#EE4B15] animate-bounce-gentle">X</span>
                </div>
                <div className="-ml-1 sm:-ml-2 mt-4 sm:mt-6 max-w-fit font-bricolage text-[#EE4B15] uppercase tracking-[-0.04em] leading-none text-[clamp(3.1rem,10vw,14.2rem)] animate-glow-orange hover:scale-[1.02] transition-transform duration-300">
                  CONNECT
                </div>
              </div>
          ...
          <div className="mt-8 lg:mt-0 flex flex-col items-center lg:items-end justify-between gap-6 lg:gap-10">
            <div className="w-full self-center lg:self-end lg:mt-auto">
              <div className="flex flex-col items-center lg:items-end leading-none uppercase font-blackhan tracking-[-0.08em] select-none hover:scale-105 transition-transform duration-500">
                <span className="text-[clamp(5rem,15.5vw,24.2rem)] mb-[-10%] lg:mb-[-18%] drop-shadow-[0_10px_35px_rgba(238,75,21,0.3)]">
                  <span className="text-[#EE4B15]">2</span>
                  <span className="text-[#F1FDFD]">0</span>
                </span>
                <span className="text-[clamp(5rem,15.5vw,24.2rem)] drop-shadow-[0_10px_35px_rgba(46,108,255,0.3)]">
