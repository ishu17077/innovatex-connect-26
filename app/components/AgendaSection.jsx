            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {(isPassedByLine || isRevealed) && (
                    <div
                      className={`absolute top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-[#EE4B15] shadow-[0_0_8px_#EE4B15] ${isEven ? 'right-0 animate-pulse' : 'left-0 animate-pulse'
                        }`}
                    />
                  )}
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className={`absolute top-0 bottom-0 w-1 bg-gradient-to-b from-[#EE4B15] via-[#FF7A45] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${isEven ? 'right-0' : 'left-0'
                        }`}
                    />

                    {/* Header Badges: Category, S.No & Duration */}
                    <div
                      className={`flex flex-wrap items-center gap-2 mb-3.5 ${isEven ? 'md:justify-end' : 'md:justify-start'
                        }`}
                    >
                    ...
                    <div
                      className={`mt-5 pt-4 border-t border-white/10 flex flex-wrap items-center justify-between gap-3 ${isEven ? 'md:flex-row-reverse' : 'md:flex-row'
                        }`}
                    >
                      {/* Timings Pill */}
