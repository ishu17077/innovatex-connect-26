    ...
    <footer className="w-full bg-gradient-to-b from-[#111436] via-[#0A0C27] to-[#050614] border-t border-white/10 rounded-t-[32px] sm:rounded-t-[48px] px-4 sm:px-6 pt-12 sm:pt-16 pb-12 text-center z-10 relative mt-[-20px] mb-0 overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-5 my-6 relative z-10">
        ...
        <div className="flex flex-col items-center gap-2 mt-4">
          ...
          <span className="text-[10px] min-[390px]:text-xs font-extrabold text-indigo-200 tracking-wider font-display max-w-xs leading-normal">JIS University, Agarpara, Kolkata</span>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full h-[12px] z-40 pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle at 10px 12px, #F8FAFC 5.5px, transparent 6px)', backgroundSize: '20px 12px', backgroundRepeat: 'repeat-x' }} />
    </footer>
  );
}
