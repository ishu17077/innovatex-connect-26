        ...
        <section className="relative z-40 -translate-y-5 bg-white bg-graph-pattern rounded-t-[42px] shadow-[0_-15px_40px_rgba(0,0,0,0.12)] pt-20 pb-28 px-6 md:px-12 border-t border-slate-100">
          ...
          <div id="ticket" className="max-w-6xl mx-auto w-full mt-40 mb-20 text-center flex flex-col items-center px-4 relative z-10">
            ...
            <div className="w-full max-w-5xl bg-gradient-to-r from-[#BD9FFF] via-[#A888FF] to-[#9169FF] rounded-[32px] p-4 md:p-5 lg:p-6 mt-12 shadow-[0_20px_50px_rgba(112,84,246,0.15)] relative overflow-hidden flex flex-col md:flex-row items-stretch justify-between gap-6 min-h-[300px]">
              ...
              {/* Ticket Background Tile Pattern */}
                ...
                <div className="flex flex-col gap-3.5 text-left">
                  {ticketBenefits.map((benefit, i) => (
                    <div key={i} className="flex items-center gap-3">
                      ...
                      <span className="text-[#1E1B4B] font-display font-extrabold text-[13px] md:text-[15px] tracking-tight leading-none">
                        {benefit}
                      </span>
                    </div>
                  ))}
              ...
              {/* Right Side: Ticket Stub (Clean normal card layout) */}
              <div className="w-full md:w-[320px] flex-shrink-0 z-10 flex flex-col justify-stretch">
                ...
                <div className="w-full h-full bg-[#F8FAFC]/95 border border-white/50 rounded-[24px] p-5 md:p-6 flex flex-col justify-between shadow-[0_8px_30px_rgba(0,0,0,0.04)] text-center relative overflow-hidden">
                  ...
                  <div className="flex flex-col items-center my-4 gap-1.5">
                    <span className="inline-flex items-center gap-1.5 text-[9px] font-black text-emerald-500 tracking-widest uppercase">
                  ...
                  <div className="w-full">
                    <button onClick={() => alert('Redirecting to checkout...')} className="flex items-center justify-between w-full px-5 py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white font-black text-xs uppercase tracking-widest rounded-xl transition-all shadow-[0_8px_20px_rgba(16,185,129,0.15)] cursor-pointer select-none border border-emerald-400/20">
                      <span className="mx-auto pl-4">Register Now</span>
                    ...
                    <p className="text-center text-[9px] text-slate-400 font-bold tracking-tight mt-3">
                      Need help? Submit an inquiry below
                    </p>
                  </div>
